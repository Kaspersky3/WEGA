...
@section('title', 'Créer un Produit - WEGA')
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="page-title">Créer un Nouveau Produit</h1>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-4" id="bulk_unit_group">
                        ...
                        <input type="text" class="form-control @error('bulk_unit_label') is-invalid @enderror" id="bulk_unit_label" name="bulk_unit_label" value="{{ old('bulk_unit_label', 'Carton') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('detail_unit_label') is-invalid @enderror" id="detail_unit_label" name="detail_unit_label" value="{{ old('detail_unit_label', 'Pièce') }}" required>
                    ...
                    <div class="col-md-4" id="conversion_group">
                        ...
                        <input type="number" min="1" class="form-control @error('units_per_bulk') is-invalid @enderror" id="units_per_bulk" name="units_per_bulk" value="{{ old('units_per_bulk', 1) }}">
            ...
            <div id="section_gros" class="form-section" style="display: none;">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('prix_achat_gros') is-invalid @enderror" id="prix_achat_gros" name="prix_achat_gros" value="{{ old('prix_achat_gros') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('prix_vente_gros') is-invalid @enderror" id="prix_vente_gros" name="prix_vente_gros" value="{{ old('prix_vente_gros') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="0" class="form-control @error('stock_gros') is-invalid @enderror" id="stock_gros" name="stock_gros" value="{{ old('stock_gros', 0) }}">
                        @error('stock_gros')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div id="section_detail" class="form-section" style="display: none;">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('prix_achat_detail') is-invalid @enderror" id="prix_achat_detail" name="prix_achat_detail" value="{{ old('prix_achat_detail') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('prix_vente_detail') is-invalid @enderror" id="prix_vente_detail" name="prix_vente_detail" value="{{ old('prix_vente_detail') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="0" class="form-control @error('stock_detail') is-invalid @enderror" id="stock_detail" name="stock_detail" value="{{ old('stock_detail', 0) }}">
                        @error('stock_detail')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
